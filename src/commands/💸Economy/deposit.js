...
module.exports = class DepositCommand extends BaseCommand {
    constructor() {
        super("deposit", "Deposit money into your bank account.", "economy", [
            {
                name: "amount",
                description: "The amount you want to deposit into you account.",
                type: "INTEGER",
                required: true,
            },
        ]);
                ...
                return interaction.followUp({
                    embeds: [
                        new MessageEmbed()
                            .setColor("RED")
                            .setDescription(
                                `> ${client.wrong} **Please provide a vaild amount to deposit**.`
                            ),
                    ],
                });

            let parsedAmount = parseInt(amount);
            if (data.coins < parsedAmount)
                return interaction.followUp({
                    embeds: [
                        new MessageEmbed()
                            .setColor("RED")
                ...
                embeds: [
                    embed
                        .setDescription(
                            `> ${
                                client.success
                            } **Successfully depostied :coin: ${parsedAmount?.toLocaleString()} to your bank**.`
                        )
                        .setColor("GREEN"),
                ],
            });
